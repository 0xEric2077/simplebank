...
import (
	...
	_ "github.com/0xEric2077/simplebank/doc/statik"
...
func runGRPCServer(config util.Config, store db.Store) {
	...
	log.Info().Str("address", config.GRPCServerAddress).Msg("gRPC server is running")
...
func runGatewayServer(config util.Config, store db.Store) {
	...
	log.Info().Str("address", listener.Addr().String()).Msg("HTTP gateway server is running")
