...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a\x15rpc_create_user.proto\x1a\x14rpc_login_user.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\x91\x02\n" +
	"\n" +
	"SimpleBank\x12\x87\x01\n" +
	"\n" +
	"CreateUser\x12\x15.pb.CreateUserRequest\x1a\x16.pb.CreateUserResponse\"J\x92A-\x12\x11Create a new user\x1a\x18Use to create a new user\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/create_user\x12y\n" +
	...
	"\vMIT License\x12:https://github.com/0xEric2077/simplebank/blob/main/LICENSE2\x031.1Z#github.com/0xEric2077/simplebank/pbb\x06proto3"
