...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a\x15rpc_create_user.proto\x1a\x14rpc_login_user.proto\x1a\x15rpc_update_user.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\x92\x03\n" +
	"\n" +
	"SimpleBank\x12\x87\x01\n" +
	"\n" +
	"CreateUser\x12\x15.pb.CreateUserRequest\x1a\x16.pb.CreateUserResponse\"J\x92A-\x12\x11Create a new user\x1a\x18Use to create a new user\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/create_user\x12\x7f\n" +
	"\n" +
	"UpdateUser\x12\x15.pb.UpdateUserRequest\x1a\x16.pb.UpdateUserResponse\"B\x92A%\x12\rUpdate a user\x1a\x14Use to update a user\x82\xd3\xe4\x93\x02\x14:\x01*2\x0f/v1/update_user\x12y\n" +
	"\tLoginUser\x12\x14.pb.LoginUserRequest\x1a\x15.pb.LoginUserResponse\"?\x92A#\x12\fLogin a user\x1a\x13Use to login a user\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/login_userB\xc4\x01\x92A\x9b\x01\x12\x98\x01\n" +
	"\x0fSimple Bank API\"5\n" +
	"\x04Eric\x12\x1dhttps://github.com/0xEric2077\x1a\x0eeric@email.com*I\n" +
	"\vMIT License\x12:https://github.com/0xEric2077/simplebank/blob/main/LICENSE2\x031.2Z#github.com/0xEric2077/simplebank/pbb\x06proto3"
